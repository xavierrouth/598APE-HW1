...
void Plane::getColor(unsigned char* __restrict__ toFill,double* __restrict__ am, double* __restrict__ op, double* __restrict__ ref, const Autonoma* const __restrict__ r, Ray ray, unsigned int depth){
   Vector dist = solveScalers(right, up, vect, ray.point-center);
