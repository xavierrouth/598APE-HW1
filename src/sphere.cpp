...
void Sphere::getColor(unsigned char* __restrict__ toFill, double*__restrict__  amb, double* __restrict__ op, double* __restrict__ ref, const Autonoma* const r, Ray ray, unsigned int depth){
