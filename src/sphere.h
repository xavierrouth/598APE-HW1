...
public:
  ...
  void getColor(unsigned char* toFill, double* __restrict__ am, double* __restrict__ op, double* __restrict__ ref, const Autonoma* const r, Ray ray, unsigned int depth);
